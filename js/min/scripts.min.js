...
//@ sourceMappingURL=js/min/bootstrap.min.min.js.map
/**
 ...
 */function rating(e,t){fillStars(e,t),ajax({data:$.param({rating:t,id:e}),func:function(t){$("#"+e+"rating .average").replaceWith(t.html),rated_items.push(e)},needs:["html"]})}function fillStars(e,t){num=t,$("#"+e+"rating .stars .star").each(function(){num>0?$(this).attr("class","star selected"):$(this).attr("class","star"),num--})}function deleteItem(e){confirm("Wollen sie diesen Beitrag wirklich löschen?")&&ajax({data:{"delete":0,id:e},func:function(e){$("#"+e.id).remove()},needs:["id"]})}function loadItems(){page<max_page&&is_loading==0&&(is_loading=!0,page++,$.ajax({type:"POST",url:rating_url2,data:$.param({page:page,sort:sort_str,phrase:phrase}),success:function(e){addLoadedItemsHTML(e)},error:function(e){addLoadedItemsHTML(e.responseText)}}))}function addLoadedItemsHTML(e,t){arguments.length==1&&(t=!0),e!=""&&(chocolat_options.length>0?(t?$(".imagelist").append(e):$(".imagelist").prepend(e),$(".imagelist a.item-content").Chocolat(chocolat_options)):t?$(".content").append(e):$(".content").prepend(e))}function search(e){phrase=e,page=1,ajax({type:"GET",data:{page:"1",phrase:phrase},func:function(e){$(".content-item").remove(),addLoadedItemsHTML(e.html)}})}function updateActionsSidebar(){if($(".sidebar").css("display")=="hidden")return;ajax({type:"GET",url:ajax_url+"/last_actions",data:{id:last_action_id},func:function(e){$(".action_list_container .action_list_item:first").before(e.html),e.last_action_id!==undefined&&(last_action_id=e.last_action_id)},needs:["html","last_action_id"]})}function sendQuote(e,t,n){var r;t&&t!=-1?r="#responses_to_"+t+" .item-quote-send ":r=".content > .item-quote-send ";var i={person:n==""?$(r+"input[name=person]").val():n,text:$(r+"textarea").val(),response_to:t};e?i.send_anonymous="":i.send="",ajax({data:i,func:function(e){t==-1?($(".content > .item-quote-send").after(e.html),$(".content > .item-quote-send textarea").val(""),$(".content > .item-quote-send input").val("")):($("#responses_to_"+t+" .add_response_container").before(e.html),$("#responses_to_"+t+" .item-quote-send textarea").val(""))},needs:["html"]})}function sendRumor(e,t){var n={response_to:t};n.text=t==-1?$(".content > .item-rumor-send textarea").val():$("#responses_to_"+t+" .item-rumor-send textarea").val(),e?n.send_anonymous="":n.send="",ajax({data:n,func:function(e){t==-1?($(".content > .item-rumor-send").after(e.html),$(".content > .item-rumor-send textarea").val("..., dass")):($("#responses_to_"+t+" .item-rumor-send").before(e.html),$("#responses_to_"+t+" .item-rumor-send textarea").val("..., dass"))},needs:["html"]})}function responseToItem(e,t){var n=$("#responses_to_"+e+" .add_response_container");if(n){window.item_response_template===undefined&&(window.item_response_template=Handlebars.compile($("#item-response-template").html()));if(n.children(".item-send").length==0){var r="",i=$("#"+e);t!=""?r=item_response_template({response_to:e,teacher:t,button_answer_title:"Hinzufügen",button_answer_ano_title:"Anonym hinzufügen"}):r=item_response_template({response_to:e,button_answer_title:"Hinzufügen",button_answer_ano_title:"Anonym hinzufügen"}),n.html(r)}else n.html("")}}function scrollToTop(){}function userCommentNotify(e){var t=$("#"+e).hasClass("notified_as_bad")?"unnotify":"notify";ajax({data:{action:t,id:e},func:function(e){var t=e.msg,n=e.id;t!="notified"?($("#"+n).addClass("notified_as_bad"),$("#"+n+" .notify").attr("title","Positiv bewerten")):t!="unnotified"&&($("#"+n).removeClass("notified_as_bad"),$("#"+n+" .notify").attr("title","Negativ bewerten"))},needs:["id","msg"]})}function sendUserComment(e){var t={text:$("#textarea").val()};e?t.send_anonymous="":t.send="",ajax({data:t,func:function(e){$(".write_comment textarea").val(""),e["html"]!=""&&$(".write_comment").after(e.html)}})}function setResultMode(e){ajax({type:"POST",url:ajax_url+"/result_mode",data:{value:e}})}function updateTimespans(){$(".timediff").each(function(){var e=$(this);e.html(timespanText(getUTCUnixTime()-e.attr("time")))})}function getUTCUnixTime(){var e=new Date;return Math.round(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes())/1e3)}function timespanText(e){var t="",n=[[1,60,["Sekunde","n","einer"]],[60,3600,["Minute","n","einer"]],[3600,86400,["Stunde","n","einer"]],[86400,2626560,["Tag","en","einem"]],[2626560,31518720,["Monat","en","einem"]],[31518720,1e10,["Jahr","en","einem"]]];for(var r=0;r<n.length;r++){var i=n[r];if(i[1]>e){var s=Math.floor(e/i[0]);t=(s==1?i[2][2]:s)+" "+(s==1?i[2][0]:i[2][0]+i[2][1]);break}}return"Vor "+t}function deleteUserComment(e){ajax({data:{deleteComment:e},func:function(e){$("#"+e.id).remove()},needs:["id"]})}function ajax(e){var t=function(t){if(t==null){e.no_return(null);return}t.logs!==undefined&&add_log_object(t.logs);if(t.data!==undefined){var n=!0;for(var r=0;r<e.needs.length;r++){var i=t.data[e.needs[r]];if(i===undefined||i==null||i==""){n=!1,e.func(!1);return}}n&&e.func(t.data)}};e=$.extend({type:"POST",dataType:"json",success:t,error:function(e,n){console.error(n),t($.parseJSON(e.responseText))},no_return:function(){},needs:[]},e),e.data=$.extend({access_key:access_key,ajax:!0},e.data),e.data!==undefined&&e.data===Object(e.data)&&(e.data=$.param(e.data)),$.ajax(e)}function add_log_object(e){weird_counter++,window.log_table_template_hbs===undefined&&(window.log_table_template_hbs=Handlebars.compile($("#log_table_template").html())),$("#log").append(log_table_template_hbs({id:weird_counter,data:e})),$("#"+weird_counter+" .tablesorter").tablesorter()}function deletePoll(e,t){t?$("#"+e).replaceWith('<input type="hidden" name="'+$id+'"/><input type="hidden" name="'+$id+'_action" value="delete"/>'):$("#"+e).remove()}function addPoll(e,t){weird_counter++,window.edit_poll_item_template===undefined&&(window.edit_poll_item_template=Handlebars.compile($("#edit_poll_item_template").html())),$(t).before(edit_poll_item_template({id:weird_counter,type:e}))}var is_loading=!1,phrase="",last_item=null,chocolat_options={},page=1;if(window.rating_url!==undefined)var rating_url2=rating_url;jQuery.fn.reverse=[].reverse,window.max_page!==undefined&&$(window).bottom({proximity:.2}).bind("bottom",function(){loadItems()}),$(".action_list_container").length>0&&setInterval("updateActionsSidebar()",auto_update_interval);if($("#drop_area").length!=0){$(".imagelist a.item-content").Chocolat(chocolat_options);var dropArea=$(".item-send")[0],file=null,file_content="",droparea_html="",progress=$(".item-send .progress");progressbar=$(".item-send .progress .bar");function traverseFiles(e){var t,n;file=e[0],file.size<35e5&&/image/i.test(file.type)&&(droparea_html=$("#drop_area").html(),$("#drop_area").html(""),typeof FileReader!="undefined"&&($("#drop_area").html("<img />"),img=$("#drop_area img"),reader=new FileReader,reader.onload=function(e){return function(t){e.attr("src",t.target.result),$("#file_input").val(file),file_content=t.target.result,$(".item-send .descr").focus()}}(img),reader.readAsDataURL(file)))}dropArea.ondragenter=function(){return!1},dropArea.ondragover=function(){return!1},dropArea.ondrop=function(e){return traverseFiles(e.dataTransfer.files),!1};var img_id;function byteToMiB(e,t){var n=Math.pow(10,t);return Math.round(e/1048567*n)/n}function uploadImage(){if(file!=null){if(window.XMLHttpRequest)var e=new XMLHttpRequest;else var e=new ActiveXObject("Microsoft.XMLHTTP");e.upload.onprogress=function(e){e.lengthComputable&&(percent=Math.round(e.loaded*100/e.total),progressbar.attr("style","width: "+percent+"%; visibility: visible"),percent<90?progressbar.html(byteToMiB(e.loaded,2)+"MiB von "+byteToMiB(e.total,2)+"MiB hochgeladen"):progressbar.html("Erzeugung von Vorschaubildern..."))},e.open("post",rating_url2,!0),e.overrideMimeType("text/plain; charset=x-user-defined-binary");var t=new FormData;t.append("uploaded_file",file),t.append("description",$(".descr").val()),t.append("category",$("input.img_category").val()),t.append("access_key",access_key),progress.attr("style","display: visible"),e.send(t),e.onreadystatechange=function(){if(e.status==200){try{var t=JSON.parse(e.response)}catch(n){console.log(n)}if(t!=null)return;t.logs!==undefined&&add_log_object(t.logs),t.data!==undefined&&t.data.html!==undefined&&($(".item-send").after(t.data.html),$(".item-send .descr").val(""),$("#drop_area").html(droparea_html),progress.attr("style","visibility: hidden"),progressbar.attr("style","width: 0%"),file=null,file_content="")}}}}}var weird_counter=23426,time_precision=3;Handlebars.registerHelper("s_to_ms",function(e){var t=Math.pow(10,time_precision);return Math.round(e*1e3*t)/t});
