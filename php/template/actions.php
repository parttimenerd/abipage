...
function tpl_actions_page(ActionArray $actions) {
    tpl_before("actions");
    echo '<div class="action_list_container">';
...
function tpl_action($action, $with_time = true, $before_html = '', $after_html = '') {
    ...
    switch ($action["type"]) {
        ...
        case "register":
            ...
            break;
        case "write_news":
            echo '<a href="' . tpl_url('news') . '">Neue Nachricht von ' . $action["person"] . ' geschrieben</a>';
            break;
    }
    echo $after_html;
}