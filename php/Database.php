...
class Database {
    ...
    public static function setup() {
        ...
        self::$db->query('CREATE TABLE IF NOT EXISTS ' . DB_PREFIX . "quotes(id INT AUTO_INCREMENT PRIMARY KEY, person VARCHAR(100), teacherid INT, text TEXT, userid INT, isanonymous TINYINT, time BIGINT, rating FLOAT NOT NULL, response_to INT, FULLTEXT(person, text)) ENGINE = MYISAM") or die("Can't create quotes table: " . self::$db->error);
        ...
        self::$db->query('CREATE TABLE IF NOT EXISTS ' . DB_PREFIX . "rumors(id INT AUTO_INCREMENT PRIMARY KEY, text TEXT, userid INT, isanonymous TINYINT, time BIGINT, rating FLOAT NOT NULL, response_to INT, FULLTEXT(text)) ENGINE = MYISAM") or die("Can't create rumours table: " . self::$db->error);
